"""Fix foreign key data type

Revision ID: 7441b7601237
Revises: 
Create Date: 2024-01-11 13:50:21.640172
...
def upgrade():
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.username'], name=op.f('fk_carts_user_id_users')),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.username'], name=op.f('fk_user_sneakers_user_id_users')),
